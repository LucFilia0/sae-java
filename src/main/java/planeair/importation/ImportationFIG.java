...
public abstract class ImportationFIG {
    ...
    /*
     * ===============================================
     * Airport's Importation
     * ===============================================
     */

    //#region AIRPORTS' IMPORTATION
         ...
         * 
         * @param airportSet The {@link planeair.util.AirportSet AirportSet} where the {@link planeair.util.Airport Airport} will be placed
         * @param airportsFile The {@link java.io.File File} which is read, to import the Airports
         *
         ...
         * 
         * @param airportSet The {@link planeair.util.AirportSet AirportSet} in which are imported the Airports
         * @param line The String that is read and contains the informations about the Airport
         * @param currentLine The current line in the source file. Used to report errors
         * 
    ...
    //#region FLIGHTS' IMPORTATION
         ...
         * 
         * @param airportSet The {@link planeair.util.AirportSet AirportSet} that contains all the Airports
         * @param fig The {@link graph.FlightsIntersectionGraph FIG} which contains all the Flights
         * @param flightsFile The source {@link java.io.File File} where the informations on the Flights are stored
            ...
            while(scanLine.hasNext()) {
                ...
                if(line.charAt(0) != '\n') { // Pass if the line is just a blank line
                    try {
                        ...
                        scanLine.close();
                        throw new InvalidFileFormatException(currentLine, iee.getMessage());
                    }
                }
            }
        ...
        //#region PRIVATE UTILIES

        /**
         * Sets the attributes of a Flight from a String, with informations separated by semi-colons ";".
         * 
         * @param airportSet The {@link planeair.util.AirportSet AirportSet} on which are contains all the {@link planeair.util.Airport Airports}
         * @param fig The {@link planeair.graph.FlightsIntersectionGraph FIG}, which contains the {@link planeair.graph.Flight Flights}
        ...
        /**
         * This procedure creates the edges of the FIG by adding an edge between two Flights if they are colliding.
         ...
         * 
         * @param fig The {@link planeair.graph.graphtype.FlightsIntersectionGraph FIG} which contains all the Flights
         * @param flight The {@link planeair.graph.graphutil.Flight Flight} from which we are adding the collisions.
         * @param timeSecurity The value, in MINUTES, of the threshold under which two Flights are in collision.
         * 
